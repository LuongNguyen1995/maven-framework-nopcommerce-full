...
public class UserRegisterPageUI {
    ...
    public static final String REGISTER_SUCESSFUL_MESSAGE = "xpath=//div[@class='result']";

    public static final String LOGOUT_LINK = "xpath=//a[@class='ico-logout']";

    public static final String ERROR_MESSAGE_MAIN_PAGE = "xpath=//div[@class='message-error validation-summary-errors']";
    public static final String BANNER_NOPCOMMERCE = "xpath=//img[@alt='nopCommerce demo store']";
